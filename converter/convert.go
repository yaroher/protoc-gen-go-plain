...
//		if err != nil {
//			zap.L().Debug("Failed to create FileDescriptor from transformed FileDescriptorProto",
...
//					zap.L().Debug("TestMessage fields in transformed FileDescriptorProto",
//						zap.Int("fields", len(msg.Field)))
//					for _, field := range msg.Field {
//						zap.L().Debug("Field in transformed FileDescriptorProto",
...
//	if msg == nil {
//		zap.L().Debug("Could not find message for type alias", zap.String("type", cleanTypeName))
//		return nil, false
//	}
//
...
//	if len(msg.Field) != 1 {
//		zap.L().Debug("Type alias message does not have exactly one field", zap.String("type", cleanTypeName), zap.Int("field_count", len(msg.Field)))
//		return nil, false
//	}
//
//	field := msg.Field[0]
//	if field.GetName() != "value" {
//		zap.L().Debug("Type alias message field is not named 'value'", zap.String("type", cleanTypeName), zap.String("field_name", field.GetName()))
//		return nil, false
//	}
//
//	// Return the type of the value field
//	zap.L().Debug("Resolved type alias",
...
//
//	// File-level virtual types are not supported by goplain options.
//
...
//	zap.L().Debug("Transforming message", zap.String("name", msg.GetName()), zap.Int("fields_before", len(msg.Field)))
//
//	// Get message options
//	msgOpts := g.getMessageOptions(msg)
//	if msgOpts != nil {
//		zap.L().Debug("Message options found",
...
//	}
//
//	zap.L().Debug("Message transformation complete",
//		zap.String("name", msg.GetName()),
...
//				zap.L().Debug("Embed option on non-message field, skipping", zap.String("field", field.GetName()))
//				continue
//			}
//
...
//			if embeddedMsg == nil {
//				zap.L().Debug("Could not find message to embed", zap.String("type", typeNameStr))
//				continue
//			}
//
...
//				zap.L().Debug("Resolving type alias",
...
//	zap.L().Debug("convertVirtualFields called",
...
//		zap.L().Debug("Processing virtual field",
//			zap.Int("index", i),
...
//		}
//
//		zap.L().Debug("Created virtual field",
//			zap.String("name", field.GetName()),
...
//	}
//
//	zap.L().Debug("convertVirtualFields returning",
...
//
//func (g *Converter) getFileOptions(file *descriptorpb.FileDescriptorProto) *goplain.FileOptions {
//	if file.Options == nil {
//		return nil
//	}
//
//	ext := proto.GetExtension(file.Options, goplain.E_File)
//	if ext == nil {
//		return nil
//	}
//
//	fileOpts, ok := ext.(*goplain.FileOptions)
//	if !ok {
//		return nil
//	}
//
...
//}
//
//func (g *Converter) getMessageOptions(msg *descriptorpb.DescriptorProto) *goplain.MessageOptions {
//	if msg.Options == nil {
//		return nil
//	}
//
//	ext := proto.GetExtension(msg.Options, goplain.E_Message)
//	if ext == nil {
//		return nil
//	}
//
...
//}
//
//func (g *Converter) getFieldOptions(field *descriptorpb.FieldDescriptorProto) *goplain.FieldOptions {
//	if field.Options == nil {
//		return nil
//	}
//
//	ext := proto.GetExtension(field.Options, goplain.E_Field)
//	if ext == nil {
//		return nil
//	}
//
...
//}
//
//func (g *Converter) getOneofOptions(oneof *descriptorpb.OneofDescriptorProto) *goplain.OneofOptions {
//	if oneof.Options == nil {
//		return nil
//	}
//
//	ext := proto.GetExtension(oneof.Options, goplain.E_Oneof)
//	if ext == nil {
//		return nil
//	}
//
...
//
//func (g *Converter) getMessageOptionsFromProto(opts *descriptorpb.MessageOptions) *goplain.MessageOptions {
//	if opts == nil {
//		return nil
//	}
//
...
//}
//
//func (g *Converter) getFieldOptionsFromProto(opts *descriptorpb.FieldOptions) *goplain.FieldOptions {
//	if opts == nil {
//		return nil
//	}
//
